...
class LocalConfig(multiconfig.DefaultConfig):
    ...
    superuser = [u"Rithvik", ]
    theme_default = u"bplus_cms"
    surge_action_limits = None # no surge protection
    sitename = u'Rtvik\'s MoinMoin Experiment'
    ...
    secrets = 'At least two-thirds of our miseries spring from human stupidity, human malice and those great motivators and justifiers of malice and stupidity: idealism, dogmatism and proselytizing zeal on behalf of religous or political ideas.'
